...
<div class="genre-header" style="background-image: url('<?php echo $url_alias; ?>/assets/img/car_oldschool.jpg'); padding: 60px 0; background-size: cover; background-position: center; color: white; text-align: center;">
  <h1 style="font-size:48px; margin:0;">OLD SCHOOL</h1>
